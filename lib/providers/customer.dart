...
class Customer with ChangeNotifier {
  ...
  Future<bool> bookArtist({
    ...
    final url = Uri.parse('$base_url/book_artist');
    final body = {
      'user_id': _userId,
      'artist_id': artistId,
      'date_string': date,
  ...
  Future<String> acceptOrRejectApp(
    ...
    var url = Uri.parse('$base_url/job_status_user');
    try {
  ...
  Future<void> getChatHistory() async {
    final url = Uri.parse('$base_url/getChatHistoryForUser');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getChat(bool isCustomer, String id) async {
    final url = Uri.parse('$base_url/getChat');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<Map<String, dynamic>> checkCoupon(
    ...
    final url = Uri.parse('$base_url/checkCoupon');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<bool> sendPayment({
    ...
    final url = Uri.parse('$base_url/makePayment');
    try {
  ...
  Future<void> getMyInvoice(bool isCustomer) async {
    final url = Uri.parse('$base_url/getMyInvoice');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<bool> editJob(Map<String, String> postData) async {
    ...
    var url = Uri.parse('$base_url/edit_post_job');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<bool> postJob(Map<String, String> postData) async {
    var url = Uri.parse('$base_url/post_job_new');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getWallet() async {
    final url = Uri.parse('$base_url/getWallet');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getWalletHistoryWithStatus(String status) async {
    final url = Uri.parse('$base_url/getWalletHistory');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<String> cancelBooking(String bookingId) async {
    final url = Uri.parse('$base_url/decline_booking');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<String> completeJob(String jobId) async {
    final url = Uri.parse('$base_url/jobComplete');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<String> deleteJob(String jobId) async {
    final url = Uri.parse('$base_url/deletejob');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getMyCurrentBookingUser() async {
    final url = Uri.parse('$base_url/getMyCurrentBookingUser');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getAllApplicants(String jobId) async {
    final url = Uri.parse('$base_url/get_applied_job_by_id');
    try {
      final response = await http.post(url, body: {
        'job_id': jobId,
      });
  ...
  Future<void> getAllJobUser() async {
    final url = Uri.parse('$base_url/get_all_job_user');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getAllCategories() async {
    final url = Uri.parse('$base_url/$_getAllCategory');
    try {
      final response = await http.post(
        url,
        body: {
      ...
      final categoriesList = data
          .map((json) => Category(
                ...
                image: json['image'] != null &&
                    ...
                    ? 'https://injuggle.com/admin/assets/category/${json['image']}'
                    : '',
              ))
          .toList();
  ...
  Future<void> getAllArtists() async {
    final url = Uri.parse('$base_url/$_getAllArtists');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getSubCategories(String catId) async {
    ...
    final url = Uri.parse('$base_url/$_getAllCategory/$catId');
    try {
      await http.post(
        url,
        body: {
  ...
  void applyPromoCode(String text) {
