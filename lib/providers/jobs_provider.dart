...
class JobProvider with ChangeNotifier {
  ...
  Future<String> startJob({
    ...
    final url = Uri.parse('$base_url/startJob');
    try {
  ...
  Future<String> rejectJob({String ajId, String jobId, String status}) async {
    var url = Uri.parse('$base_url/job_status_artist');
    try {
  ...
  Future<String> applyToJob({
    ...
    final url = Uri.parse('$base_url/applied_job');
    try {
      final response = await http.post(url, body: {
        'user_id': userId,
        'job_id': jobId,
  ...
  Future<void> getCurrentBookingsArtist() async {
    var url = Uri.parse('$base_url/getMyCurrentBooking');
    try {
  ...
  Future<void> getAllBookingsArtist(String flag) async {
    var url = Uri.parse('$base_url/getAllBookingArtist');
    try {
      final response = await http.post(url, body: {
        'artist_id': _userId,
        'booking_flag': flag,
  ...
  Future<bool> bookingOperation(String request, String id) async {
    var url = Uri.parse('$base_url/booking_operation');
    try {
      final response = await http.post(url, body: {
        'user_id': _userId,
        'request': request,
  ...
  Future<bool> declineOperation(String id) async {
    var url = Uri.parse('$base_url/decline_booking');
    try {
      final response = await http.post(url, body: {
        'user_id': _userId,
        'booking_id': id,
  ...
  Future<void> getArtistEarnings() async {
    var url = Uri.parse('$base_url/myEarning1');
    try {
      final response = await http.post(url, body: {
        'artist_id': _userId,
      });
  ...
  Future<String> walletRequest() async {
    var url = Uri.parse('$base_url/walletRequest');
    try {
      final response = await http.post(url, body: {
        'user_id': _userId,
      });
  ...
  Future<void> getChatForArtist() async {
    var url = Uri.parse('$base_url/getChatHistoryForArtist');
    try {
      final response = await http.post(url, body: {
        'artist_id': _userId,
      });
  ...
  Future<void> getAppliedJobs() async {
    var url = Uri.parse('$base_url/get_applied_job_artist');
    try {
      final response = await http.post(url, body: {
        'artist_id': _userId,
      });
  ...
  Future<void> getAllJobs() async {
    var url = Uri.parse('$base_url/get_all_job');
    try {
      final response = await http.post(url, body: {
        'artist_id': _userId,
      });
  ...
  Future<void> fetchSliderImages() async {
    var url = Uri.parse('$base_url/get_sliders');
    try {
  ...
  Future<void> getNotifications(context) async {
    var url = Uri.parse('$base_url/getNotifications');
  ...
  Future<void> getTickets() async {
    var url = Uri.parse('$base_url/getMyTicket');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> addTicket(String title, String description) async {
    var url = Uri.parse('$base_url/generateTicket');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<void> getTicketComments(String ticketId) async {
    _ticketComments = [];
    var url = Uri.parse('$base_url/getTicketComments');
    try {
      final response = await http.post(
        url,
        body: {
  ...
  Future<bool> sendComment(String ticketId, String comment) async {
    var url = Uri.parse('$base_url/addTicketComments');
    try {
      final response = await http.post(
        url,
        body: {
